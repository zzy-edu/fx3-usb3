/*
 * Project Name: sync_gpif2_user.cyfx
 * Time : 05/27/2025 16:06:33
 * Device Type: FX3
 * Project Type: GPIF2
 *
 *
...
uint16_t CyFxGpifTransition[]  = {
    0x0000, 0x8888, 0x4444, 0x5555, 0x1F1F, 0x7F7F
};
...
CyU3PGpifWaveData CyFxGpifWavedata[]  = {
    ...
    {{0x4E002702,0x20030202,0x80000000},{0x1E700105,0x00020304,0x80000000}},
    {{0x1E700101,0x00020304,0x80000000},{0x5E040703,0x20000200,0xC0100000}},
    {{0x4E002702,0x20030202,0x80000000},{0x1E700101,0x00020304,0x80000000}},
    {{0x00000000,0x00000000,0x00000000},{0x00000000,0x00000000,0x00000000}},
    {{0x5E040703,0x20000200,0xC0100000},{0x3E738704,0x00000200,0xC0100000}}
};
...
uint8_t CyFxGpifWavedataPosition[]  = {
    0,1,2,0,0,3,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,
...
uint32_t CyFxGpifRegValue[]  = {
    ...
    0x000004AC,  /*  CY_U3P_PIB_GPIF_BUS_CONFIG */
